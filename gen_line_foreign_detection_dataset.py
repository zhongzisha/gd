...
def paste_fg_images_to_bg(im, mask, fg_images):
    im = im.copy()
    mask = mask.copy()
    boxes = []
...
def add_line_to_image(im, crop_width=0, crop_height=0, subset='train',
    ...
    if foreign_fg_filenames is not None:
        ...
        im_sub1, im_sub1_com, im_sub1_blend, mask1, boxes1, boxes1_mask = \
            paste_fg_images_to_bg(im_sub, mask, fg_images)
...
if __name__ == '__main__':
    ...
    if os.name == 'nt':
        ...
        save_root = 'E:/line_foreign_object_detection/augmented_data/'
        ...
        #                          fg_images_filename=None, fg_boxes_filename=None,
        #                          bg_images_dir=bg_images_dir, random_count=4000,
