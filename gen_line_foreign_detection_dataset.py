...
def generate_test_images():
    if os.name == 'nt':
        source = 'G:/gddata/all'
        gt_dir = 'G:\\gddata\\all'
        save_root = 'E:\\generated_big_test_images\\line_foreign'
        ...
        save_root = '/media/ubuntu/Data/generated_big_test_images/line_foreign'
        foreign_fg_dir = '/media/ubuntu/Data/line_foreign_object_detection/fg_images'
    ...
    for tiffile in tiffiles:
        ...
        for batch_idx, img_filename in enumerate(img_filenames):
            ...
            fg_count = np.random.randint(low=0, high=2)
            while True:
                random_filenames = np.random.choice(foreign_fg_filenames,
                                                    size=total_count,
                                                    replace=True)
